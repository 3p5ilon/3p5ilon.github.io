          ...
          case "\t": // tab
            ...
            if (term.tabBase !== term.currentLine) {
              ...
              if (tabParts.length === 1) {
                ...
                term.tabOptions = Object.keys(social)
                  .filter((n) => n.startsWith(tabRest))
                  .sort();
              } else if (["projects"].includes(tabCmd)) {
                term.tabOptions = Object.keys(projects)
                  .filter((p) => p.startsWith(tabRest))
                  .sort();
              }
            }
...
function colorText(text, color) {
  const colors = {
    command: "\x1b[38;5;51m", // bright cyan – commands
    hyperlink: "\x1b[38;5;81m", // vivid blue – links
    // user: "\x1b[38;5;220m",  // golden yellow – username
    user: "\x1b[38;5;226m", // bright yellow – username
    prompt: "\x1b[38;5;118m", // light green – $
    bold: "\x1b[38;5;15m", // bright white – emphasis
    // host: "\x1b[38;5;15m", // white – hostname
    // sep: "\x1b[38;5;15m", // white – separator (@)
  };
